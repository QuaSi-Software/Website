...
The latest release can be found [here](https://github.com/QuaSi-Software/GenSim/releases) and a detailed user manual is available within the [documentation of the QuaSi project](https://quasi-software.readthedocs.io/en/latest/gensim_user_manual/).

<div class="row">
    <img class="col" src="{{'assets/logos/gensim.svg' | absolute_url}}" style="max-width: 400px;"/>
</div>
